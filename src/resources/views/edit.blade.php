                ...
                @foreach ($columns as $column)
                    ...
                    <div class="form-group">
                        ...
                        @elseif($column['type'] == 'date')
                            ...
                            {!! $label !!}
                            <div class="col-sm-4">
                                <input id="div{!! $column['campoReal'] !!}" type="text" class="form-control catalogoFecha"
                                    name="{{ $column['campoReal'] }}" value="{{ $laFecha }}" {!! arrayToFields($arr) !!}>
                            </div>
                            <!---------------------------- DATETIME ---------------------------------->
                        @elseif($column['type'] == 'datetime')
                            ...
                            <div class="col-sm-4">
                                <input id="div{!! $column['campoReal'] !!}" type="text" class="form-control catalogoFecha"
                                    name="{{ $column['campoReal'] }}" value="{{ $laFecha }}"
                                    {!! arrayToFields($arr) !!}>
                            </div>
                            <!---------------------------- TIME ---------------------------------->
